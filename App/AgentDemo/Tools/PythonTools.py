...
from App.AgentDemo.Utils.CallbackHandlers import ColoredPrintHandler
from App.AgentDemo.Utils.PrintUtils import CODE_COLOR
from App.AgentDemo.Tools.ExcelTools import get_first_n_rows
...
class ExcelAnalyser:
    ...
    def __init__(self, prompt_file="./prompts/Tools/excel_analyser.txt.txt", verbose=False):
